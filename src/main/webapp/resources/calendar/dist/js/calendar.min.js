!function (a) {
    ...
    a.xvDate = function (a) {
        ...
        if ("object" == typeof c && c.length) for (var d = [], e = 0; e < c.length; e++) d.push(b.getId(c[e])), b.enable(d[e], d, a); else d = b.getId(c), b.enable(d, d, a)
    }, b.fn = b.prototype = {
        init: function (a) {
            this.creatView(a), this.initTimes(!1)
        }, gb: {}, creatView: function (a) {
            var c, d = a || {}, e = this, f = d.targetId || "dates", g = b.getId(f);
