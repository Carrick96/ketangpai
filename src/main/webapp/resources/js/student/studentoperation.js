$(function () {
    stuLoseFocus();   //学生注册失去焦点
    stuSetFocus();    //学生注册获取焦点

    function stuSetFocus() {
// 文本框
